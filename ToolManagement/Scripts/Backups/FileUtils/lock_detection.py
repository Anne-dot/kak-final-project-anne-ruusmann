...
def check_rename_lock(file_path):
    ...
    try:
        ...
        return True, f"File is locked (rename test): {e!s}"
    except Exception as e:
        logging.warning(f"Error in rename lock check: {e!s}")
        return False, ""
...
def check_write_lock(file_path):
    ...
    try:
        ...
        return True, f"File is locked (write test): {e!s}"
    except Exception as e:
        logging.warning(f"Error in write lock check: {e!s}")
        return False, ""
...
def check_windows_handles(file_path):
    ...
    try:
        ...
        logging.warning(f"Error in Windows handle check: {e!s}")
        return False, ""
