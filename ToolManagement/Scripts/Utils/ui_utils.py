...
class UIUtils:
    ...
    @staticmethod
    def select_dxf_file(dxf_dir: str) -> str | None:
        """
    ...
    def select_file(
        ...
        try:
            ...
            if file_types is None:
                file_types = [("All Files", "*.*"), ("DXF Files", "*.dxf"), ("CSV Files", "*.csv")]
            ...
            try:
                ...
                if save_dialog:
                    file_path = filedialog.asksaveasfilename(
                        title=title, initialdir=initial_dir, filetypes=tk_file_types
                    )
                else:
        ...
        try:
            ...
            if not save_dialog and not os.path.exists(file_path):
                return (
                    ...
                    {"error": "File not found", "file_path": file_path},
                )
            ...
            return False, f"CLI file selection failed: {e!s}", {"error": str(e)}

    @staticmethod
    def message_dialog(
        message: str, title: str = "Information", message_type: str = "info"
        ...
        try:
            ...
            return ErrorHandler.create_success_response(
                message="Dialog shown", data={"message_type": message_type}
            )
