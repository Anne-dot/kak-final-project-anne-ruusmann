...
class PathUtils:
    ...
    def get_data_dir(cls):
        ...
        if platform.system() == "Windows" and "Mach3" in root_dir.parts:
            ...
            data_dir = (
                root_dir / AppConfig.paths.TOOL_MANAGEMENT_DIR_NAME / AppConfig.paths.DATA_DIR_NAME
            )
        else:
    ...
    def get_logs_dir(cls):
        ...
        if platform.system() == "Windows" and "Mach3" in root_dir.parts:
            # In Mach3 production environment
            logs_dir = (
                root_dir / AppConfig.paths.TOOL_MANAGEMENT_DIR_NAME / AppConfig.paths.LOGS_DIR_NAME
            )
        else:
            # In development environment
    ...
    def get_test_data_dir(cls):
        ...
        if platform.system() == "Windows" and "Mach3" in root_dir.parts:
            ...
            test_data_dir = (
                root_dir
                / AppConfig.paths.TOOL_MANAGEMENT_DIR_NAME
                / AppConfig.paths.SCRIPTS_DIR_NAME
                / AppConfig.paths.TESTS_DIR_NAME
                / AppConfig.paths.TEST_DATA_DIR_NAME
            )
        else:
            # In development environment
