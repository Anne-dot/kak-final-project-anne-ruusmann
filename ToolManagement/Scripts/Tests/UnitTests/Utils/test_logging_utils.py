...
class TestLoggingUtils(unittest.TestCase):
    ...
    def test_log_levels(self):
        ...
        logger = self.original_setup_logger(
            logger_name, level=logging.DEBUG, console_level=logging.ERROR
        )
    ...
    def test_log_exception(self):
        ...
        self.assertTrue(
            any("Division error" in msg for msg in log_output)
            or "Expected log message 'Division error' not found"
        )
