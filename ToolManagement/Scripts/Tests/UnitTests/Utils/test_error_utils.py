...
class TestErrorUtilsExceptions(unittest.TestCase):
    ...
    def test_file_error(self):
        ...
        error = FileError("File corrupted", severity=ErrorSeverity.CRITICAL)
        self.assertEqual(error.severity, ErrorSeverity.CRITICAL)
    ...
    def test_validation_error(self):
        ...
        error = ValidationError("Value out of range", field="temperature", value=150)
    ...
    def test_configuration_error(self):
        ...
        # Check with param
        error = ConfigurationError("Invalid setting", param="timeout")
...
class TestErrorHandler(unittest.TestCase):
    ...
    def test_create_success_response(self):
        ...
        success, message, data = ErrorHandler.create_success_response(
            message="Item created successfully", data=result_data
        )
