...
class TestMachineSettings(unittest.TestCase):
    ...
    def test_initialization_with_defaults(self):
        ...
        self.assertEqual(self.settings.settings["drilling_feed_rate"], 
                         AppConfig.gcode.DRILLING_FEED_RATE)
        self.assertEqual(self.settings.settings["approach_distance"], 
                         AppConfig.gcode.SAFE_APPROACH_DISTANCE)
        self.assertEqual(self.settings.settings["decimal_precision"], 
                         AppConfig.gcode.DECIMAL_PRECISION)
    ...
    def test_initialization_with_custom_settings(self):
        ...
        self.assertEqual(custom_machine_settings.settings["rapid_feed_rate"],
    ...
    def test_get_feed_rate(self):
        ...
        self.assertEqual(self.settings.get_feed_rate("drilling"), 
                         AppConfig.gcode.DRILLING_FEED_RATE)
        self.assertEqual(self.settings.get_feed_rate("rapid"), 
                         AppConfig.gcode.RAPID_POSITIONING_FEED_RATE)
        self.assertEqual(self.settings.get_feed_rate("retraction"), 
                         AppConfig.gcode.RETRACTION_FEED_RATE)
        
        # Test unknown operation type (should default to drilling)
        self.assertEqual(self.settings.get_feed_rate("unknown"), 
                         AppConfig.gcode.DRILLING_FEED_RATE)
    
    def test_get_approach_and_clearance_distance(self):
        """Test retrieval of approach and clearance distances."""
        self.assertEqual(self.settings.get_approach_distance(), 
                         AppConfig.gcode.SAFE_APPROACH_DISTANCE)
        self.assertEqual(self.settings.get_clearance_distance(), 
                         AppConfig.gcode.SAFE_CLEARANCE_DISTANCE)
