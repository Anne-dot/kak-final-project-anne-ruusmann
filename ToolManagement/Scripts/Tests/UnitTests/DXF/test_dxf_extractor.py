...
class TestDXFExtractor(unittest.TestCase):
    ...
    def _create_valid_file(self):
        ...
        msp.add_circle(
            center=(100, 100, 0), radius=4.0, dxfattribs={"layer": "EDGE.DRILL_D8.0_P15.0"}
        )
        msp.add_circle(
            center=(200, 100, 0), radius=5.0, dxfattribs={"layer": "EDGE.DRILL_D10.0_P20.0"}
        )
    ...
    def test_skipped_points_reporting(self):
        ...
        mock_drill_result = {
            ...
            "issues": [
                ...
                {
                    "entity_type": "CIRCLE",
                    "layer": "EDGE.DRILL_D0.0_P15.0",
                    "position": "(400, 100, 0)",
                },
                {
                    "entity_type": "CIRCLE",
                    "layer": "EDGE.DRILL_D8.0_P0.0",
                    "position": "(500, 100, 0)",
                },
            ],
        }
        ...
        with patch.object(
            self.extractor.workpiece_extractor,
            "extract",
            return_value=(wp_success, wp_message, mock_wp_result),
        ):
            with patch.object(
                self.extractor.drill_extractor,
                "extract",
                return_value=(drill_success, drill_message, mock_drill_result),
            ):
                # Process the document
