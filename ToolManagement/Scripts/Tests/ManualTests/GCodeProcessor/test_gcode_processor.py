...
class GCodeTestRunner:
    ...
    def test_normalizer(self, input_file: Path) -> tuple[bool, str, dict[str, Any]]:
        ...
        try:
            success, message, details = normalizer.normalize_file(str(input_file), str(output_file))
            ...
            error_msg = f"Normalizer test exception: {e!s}"
    ...
    def test_preprocessor(self, input_file: Path) -> tuple[bool, str, dict[str, Any]]:
        ...
        try:
            ...
            error_msg = f"Preprocessor test exception: {e!s}"
            self.logger.error(error_msg)
            return False, error_msg, {}

    def run_all_tests(self) -> None:
        """Run all tests and report results."""
        print("G-code Processor Test Runner")
