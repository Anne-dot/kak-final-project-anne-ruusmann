...
class BackupManagerTester:
    ...
    def test_restore(self):
        ...
        restore_success, restore_message, restore_details = backup_mgr.restore_from_backup(backup_path, restore_path)
    ...
    def test_file_locking(self):
        ...
        if locking_success:
            ...
            logger.error(f"File locking test failed: First backup: {success1}, Second backup: {success2}")
        
        return locking_success, "File locking test completed", {
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            all_passed = (backup_success and rotation_success and 
                          restore_success and locking_success)
            
            overall_status = "ALL TESTS PASSED" if all_passed else "SOME TESTS FAILED"
            print(f"\nOverall: {overall_status}")
            logger.info(f"Test suite completed: {overall_status}")
            
            return all_passed, overall_status, {
