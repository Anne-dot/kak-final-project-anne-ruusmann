...
def print_drill_points_table(drill_points: List[Dict]) -> None:
    ...
    for i, point in enumerate(drill_points, 1):
        ...
        print("{:<4} {:<30} {:<15.2f} mm {:<15} {:<20}".format(
            i, position_str, diameter, direction_str, str(group_key)
        ))
...
def print_groups_summary(groups: Dict) -> None:
    ...
    print("{:<4} {:<20} {:<15} {:<10}".format(
        "#", "Group Key", "Direction", "Count"
    ))
    print("-" * 50)
    ...
    for i, ((diameter, direction), points) in enumerate(groups.items(), 1):
        ...
        print("{:<4} {:<20.2f} mm {:<15} {:<10}".format(
            i, diameter, direction_str, len(points)
        ))
